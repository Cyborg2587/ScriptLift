...
declare const jspdf: any; // Accessed via CDN in index.html
...
export const downloadPdf = (
  ...
  data.segments.forEach((seg) => {
    ...
    y += splitText.length * 6 + 2; // small gap between segments
  });
...
export const downloadDoc = (
  ...
  // We use a simple HTML structure compatible with Word
  const header = `
